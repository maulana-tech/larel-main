...
impl FaucetToken {
    ...
    // --- SEP-41 subset used by the pool & router ---

    pub fn approve(_env: Env, from: Address, _spender: Address, _amount: i128, _expiration_ledger: u32) {
        from.require_auth();
        // Since this is a permissionless testnet faucet token, we accept all approvals
        // and allow transfer_from without strict allowance bookkeeping.
    }

    pub fn allowance(_env: Env, _from: Address, _spender: Address) -> i128 {
        i128::MAX // Infinite allowance for easy integration testing
    }
