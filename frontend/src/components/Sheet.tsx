...
export function Sheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center" role="dialog" aria-modal="true">
      ...
      <div className="animate-fade-in relative z-10 flex max-h-[92vh] w-full max-w-[460px] flex-col rounded-none border border-ink-700 bg-ink-900 shadow-panel sm:rounded-none">
        <div className="flex items-center justify-between border-b border-ink-800 px-5 py-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="flex h-8 w-8 items-center justify-center rounded-none text-zinc-500 transition hover:bg-ink-800 hover:text-zinc-200"
          >
