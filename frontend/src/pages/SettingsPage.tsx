...
export function SettingsPage() {
  ...
  return (
    ...
    >
      <div className="space-y-8 rounded-2xl border border-spectral/10 bg-ink-900/40 p-6 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
              {locales.map((l) => (
                <button
                  ...
                  className={cx(
                    'rounded-xl border py-2.5 text-xs font-semibold uppercase tracking-wider transition font-mono',
                    locale === l.code
            ...
            <div className="flex gap-2">
              {(['light', 'dark'] as const).map((tCode) => (
                <button
                  ...
                  className={cx(
                    'flex-1 rounded-xl border py-2.5 text-xs font-semibold uppercase tracking-wider transition font-mono',
                    theme === tCode
                      ? 'border-patina-400 bg-patina-400/10 text-spectral-soft'
                      : 'border-spectral/12 bg-ink-950/20 text-spectral/60 hover:border-spectral/40 hover:text-spectral-soft',
                  )}
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-xl border border-spectral/8 bg-ink-950/30 p-4 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded bg-patina-400/10 px-2 py-0.5 font-mono text-xs font-semibold text-patina-400">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-spectral/8 bg-ink-950/30 px-3 py-2">
              ...
              <button
                ...
                className="text-[11px] font-mono uppercase tracking-wider text-patina-400/80 hover:text-patina-400 px-2 py-1 hover:bg-patina-400/5 rounded transition shrink-0"
              >
