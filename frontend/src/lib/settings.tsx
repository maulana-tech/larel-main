...
const en = {
  ...
  'settings.about': 'Larel is a privacy-preserving financial layer built on Stellar.',
...
const id = {
  ...
  'settings.about': 'Larel adalah lapisan finansial penjaga privasi di Stellar.',
...
const vi = {
  ...
  'settings.about': 'Larel là một lớp tài chính bảo mật được xây dựng trên Stellar.',
...
const fil = {
  ...
  'settings.about': 'Ang Larel ay isang privacy-preserving financial layer sa Stellar.',
  'settings.byline': 'Larel App',
  'settings.langEn': 'English',
  'settings.langId': 'Bahasa Indonesia',
  'settings.langVi': 'Tiếng Việt',
