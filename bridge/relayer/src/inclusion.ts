/**
 * Inclusion feed -> `LarelBridge` Soroban contract.
 *
 * Given a Larel note `commitment` (or a watched L1 `Locked` event), the relayer:
...
/** Builds / submits `bridge_in` operations against a deployed `LarelBridge` contract. */
