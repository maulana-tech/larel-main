/**
 * `@larel/relayer` — UNTRUSTED transport for the Larel cross-chain bridge.
 *
 ...
 *
 * CLI:
 *   larel-relayer relay-header [--post-root] [--submit]
 *   larel-relayer relay-in <commitment> [--block N] [--token 0x..] [--amount N] [--submit]
 *   larel-relayer watch [--interval-ms N]
 *   larel-relayer help
 *
